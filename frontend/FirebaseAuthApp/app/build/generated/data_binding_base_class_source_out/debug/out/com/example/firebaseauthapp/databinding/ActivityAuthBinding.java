...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  private ActivityAuthBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      ...
      @NonNull TextInputEditText etPassword, @NonNull TextView tvMessage) {
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAuthBinding((LinearLayout) rootView, btnLogin, btnRegister, etEmail,
          etPassword, tvMessage);
    }
